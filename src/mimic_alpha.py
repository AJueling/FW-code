...
# added from https://stackoverflow.com/questions/33371939/calculate-rgb-equivalent-of-base-colors-with-alpha-of-0-5-over-white-background
def make_color_transparent(color, alpha, bg_color='w'):
    """ convert named color on named bg_color, alpha in  [0,1] """
    rgb = cC.to_rgb(color)
    bg_rgb = cC.to_rgb(bg_color)
